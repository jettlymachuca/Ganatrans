<%-- 
    ...
    Created on : 24/03/2022, 11:23:22 AM
    Author     : Sena
--%>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="form-validation">
                                        <h3>ACTUALIZAR VEHICULO</h3><br><br>
                                        <%            VehiculoVO VehVO = (VehiculoVO) request.getAttribute("vehiculoConsultado");
                                            if (VehVO != null) {

                                        %>
                                        <form class="form-valide" action="Vehiculo" method="post">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" >Placa:<span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                                    <input type="text" class="form-control" name="txtPlaca" value="<%=VehVO.getPlaca()%>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-6">
                                                    <input type="text" class="form-control" name="txtColor" value="<%=VehVO.getColor()%>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-6">
                                                    <input type="number" class="form-control" name="txtModelo" value="<%=VehVO.getModelo()%>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-6">
                                                    <input type="date" class="form-control" name="txtSeguro_Fecha_Vencimiento" value="<%=VehVO.getSeguro_Fecha_Vencimiento()%>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
