<%-- 
    ...
    Created on : 23/03/2022, 09:12:48 AM
    Author     : Sena
--%>
...
<html>
    ...
    <body>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="form-validation">
                                        <h3>REGISTRAR CARRERA</h3><br><br>
                                        <form class="form-valide" action="Carrera" method="post" name="formCarrera">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" for="val-skill">Placa Vehiculo<span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                                    <select class="form-control" id="val-skill" name="txtIdVehiculo">
                                                    ...
                                                    <label id="errorIdVehiculo" style="color: red"></label>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-6">
                                                    <select class="form-control" id="val-skill" name="txtIdUsuario">
                                                        <option>Selecione...</option>
                                                        <%
                                                    ...
                                                    <label id="errorIdUsuario" style="color: red"></label>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-6">
                                                    <input type="number" class="form-control" name="txtValor" placeholder="Ingrese el Precio" >
                                                    <label id="errorValor" style="color: red"></label>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <label id="errorDireccion" style="color: red"></label>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-6">
                                                    <input type="time" class="form-control" name="txtHora_Inicio">
                                                    <label id="errorHoraInicio" style="color: red"></label>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-6">
                                                    <input type="time" class="form-control" name="txtHora_Final">
                                                    <label id="errorHoraFin" style="color: red"></label>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <label id="errorFecha" style="color: red"></label>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-lg-8 ml-auto">
                                                    <input type="hidden" value="1" name="opcion">
                                                    <input type="submit" class="btn btn-danger" value="Registrar" onclick="return validarCarrera();">
                                                </div>
                                            </div>
                                            <div>
        ...
        ***********************************-->
        ...
        <script src="Validaciones/ValidacionRegistroCarrera.js"></script>
