<%-- 
    ...
    Created on : 22/05/2022, 11:54:51 AM
    Author     : HP PRO
--%>
                                    ...
                                    <div class="form-validation">
                                        ...
                                        <form class="form-valide" action="Usuario" method="post">
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" >Contraseña Actual: <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                                    <input type="password" class="form-control" placeholder="Ingrese su Actual Contraseña" name="txtPassword" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label" >Nueva Contraseña: <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                                    <input type="password" class="form-control" placeholder="Ingrese una Nueva Contraseña" name="txtPassword1" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-lg-4 col-form-label">Confirmar Contraseña: <span class="text-danger">*</span>
                                                </label>
                                                <div class="col-lg-6">
                                                    <input type="password" class="form-control" placeholder="Confirme la Contraseña" name="txtPasswordNueva" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
